...
void Renderer::buildMeshes() {
    ...
    svgMesh = MeshFactory::buildSVG(device, //"/Users/rashmig/Desktop/CODE_PROJECT/line/horizontal-line-svgrepo-com.svg"
        //"/Users/rashmig/Desktop/CODE_PROJECT/line/line-m-svgrepo-com.svg"
        "/Users/rashmig/Desktop/CODE_PROJECT/line/horizontal-line-svgrepo-com.svg");
    lineMesh = MeshFactory::buildLine(device);
}
...
void Renderer::draw(MTK::View* view) {
    ...
    encoder->drawIndexedPrimitives(MTL::PrimitiveType::PrimitiveTypeLine, quadMesh.indexBuffer->length() / sizeof(ushort), MTL::IndexType::IndexTypeUInt16, quadMesh.indexBuffer, 0);

    // Draw line
    encoder->setVertexBuffer(lineMesh.vertexBuffer, 0, 0);
    encoder->drawIndexedPrimitives(MTL::PrimitiveType::PrimitiveTypeLine, lineMesh.indexBuffer->length() / sizeof(ushort), MTL::IndexType::IndexTypeUInt16, lineMesh.indexBuffer, 0);

    // Draw SVG
    encoder->setVertexBuffer(svgMesh.vertexBuffer, 0, 0);
    encoder->drawIndexedPrimitives(MTL::PrimitiveType::PrimitiveTypeLine, svgMesh.indexBuffer->length() / sizeof(ushort), MTL::IndexType::IndexTypeUInt16, svgMesh.indexBuffer, 0);
